    ...
    public static ExerciseTypeBFragment newInstance(ExerciseTypeB exercise, int index, int total) {
        ...
        if (flags != null) {
            for (int i = 0; i < flags.size(); i++)
                flagsArr[i] = Boolean.TRUE.equals(flags.get(i));
        }
